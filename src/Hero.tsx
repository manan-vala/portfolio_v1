...
function Hero() {
  return (
    <div className="hero w-full min-h-screen flex flex-col items-center justify-center">
      <div className="navbar w-9/10 mt-5 flex items-center justify-between">
        <motion.div
      ...
      >
        ...
        <h1 className="font-instrument text-7xl text-gray-400 text-center">
        ...
        <h3 className="font-manrope text-[1.75rem] text-gray-400 text-center">
          If you are looking for transforming your ideas into reality, Lets
          Connect!
        </h3>
        <button className="flex px-4 pl-6 py-3 gap-2 items-center justify-between text-2xl text-center text-white font-montserrat font-medium bg-purple-600  shadow-lg shadow-purple-600/70 p-2 rounded-full ">
          View my work
          <motion.div
            initial={{ rotate: 45 }}
            whileHover={{ rotate: 0 }}
