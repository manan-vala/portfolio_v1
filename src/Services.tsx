function Services() {
  return (
    <div className="w-full min-h-screen flex flex-col items-center justify-center gap-10 py-20">
      ...
      <div className="w-8/10 grid grid-cols-3 gap-8">
        <div className="h-70 text-gray-400 font-manrope flex flex-col gap-4 bg-[linear-gradient(to_bottom,rgba(30,30,30,0.7),rgba(15,15,15,1))] border-1 border-gray-600 rounded-xl p-8 col-span-2">
          <h5 className="text-white text-2xl font-semibold">Landing Page</h5>
        ...
        <div className="h-70 text-gray-400 font-manrope flex flex-col gap-4 bg-[linear-gradient(to_bottom,rgba(30,30,30,0.7),rgba(15,15,15,1))] border-1 border-gray-600 rounded-xl p-8">
